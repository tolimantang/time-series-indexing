"""
Enhanced Hourly Lunar Backtesting Strategy

This module implements precise lunar transit analysis using hourly price data,
with intelligent weekend/holiday handling and automatic pattern storage.
"""
...
class EnhancedHourlyLunarBacktester:
    """Enhanced lunar backtesting with hourly precision and auto-storage"""

    def __init__(self, db_config: Optional[Dict[str, Any]] = None):
        """Initialize the backtester with database configuration"""
    ...
    def get_lunar_position(self, julian_day: float) -> Optional[Dict[str, Any]]:
    ...
    def calculate_aspects(self, moon_long: float, planet_positions: Dict[str, Dict[str, Any]]) -> List[Dict[str, Any]]:
    ...
    def dt_to_julian(self, dt: datetime) -> float:
    ...
    def get_hourly_price_data(self, market_symbol: str) -> List[Tuple[datetime, float, float, float, float]]:
    ...
    def analyze_weekend_gap_strategy(self, market_symbol: str) -> List[Dict[str, Any]]:
    ...
    def run_enhanced_hourly_analysis(self, market_symbol: str, display_name: str) -> List[Dict[str, Any]]:
    ...
    def update_pattern(self, pattern_data: Dict[str, Any], direction: str, price_change: float,
                      timestamp: datetime, **metadata) -> None:
    ...
    def display_results(self, patterns: List[Dict[str, Any]], display_name: str, weekend_count: int) -> None:
    ...
    def store_patterns_to_db(self, patterns: List[Dict[str, Any]], market_symbol: str) -> int:
